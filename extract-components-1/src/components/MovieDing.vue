...
const elfilm = defineProps(['defilm'])
const deemits = defineEmits(['updatenzo'])
const movie = elfilm.defilm
function updateRating(unomovie, rating) {
  unomovie.rating = rating;
}
function gaupdaten(defilmid){
    deemits('updatenzo', defilmid)
}
</script>
<template>
    <div>
        AB {{ elfilm.defilm.name }}-
