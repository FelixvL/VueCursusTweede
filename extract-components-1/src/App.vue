...
import MovieDing from './components/MovieDing.vue'
import MovieFormuliertje from "./components/MovieFormuliertje.vue";
...
function editMovie(movieId) {
  ...
  const movie = movies.value[movieId-1];
...
function voegmaartoe(pr){
  console.log("voegmaartoe");
  console.log(pr)
  form.value = pr
  movies.value.push(form.value);
